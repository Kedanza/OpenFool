...
assert(aiAttack.ATTACK_BONUSES[1] == 0.0, "0 cards bonus should be 0.0")
assert(aiAttack.ATTACK_BONUSES[2] == 0.0, "1 card bonus should be 0.0")
assert(aiAttack.ATTACK_BONUSES[3] == 1.0, "2 cards (pair) bonus should be 1.0")
assert(aiAttack.ATTACK_BONUSES[4] == 1.5, "3 cards (triple) bonus should be 1.5")
assert(aiAttack.ATTACK_BONUSES[5] == 2.5, "4 cards (quad) bonus should be 2.5")
...
assert(bestCard == nil, "Empty hand should return nil")

-- Test 2: Single card
hand = {card.createCard(card.Suit.HEARTS, card.Rank.SEVEN)}
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Single card should return that card")
assert(bestCard.rank == card.Rank.SEVEN, "Should return the only card (7)")
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card from hand with pair")
assert(bestCard.rank == card.Rank.TEN, "Should throw from the pair (10), not singleton (K)")
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card")
assert(bestCard.rank == card.Rank.SIX, "Should throw low card (6) and keep ACE")
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card")
assert(bestCard.suit == card.Suit.HEARTS, "Should throw non-trump and keep trump")
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card from hand with triple")
assert(bestCard.rank == card.Rank.NINE, "Should throw from the triple (9)")
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card from complex hand")
-- Should prefer low pair over singleton or high cards
assert(bestCard.rank == card.Rank.SIX or bestCard.rank == card.Rank.SEVEN,
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card in endgame")
-- In endgame, strategy might change but should still return valid card
assert(bestCard.rank == card.Rank.TEN or bestCard.rank == card.Rank.JACK or bestCard.rank == card.Rank.QUEEN,
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card from quad")
assert(bestCard.rank == card.Rank.EIGHT, "Should return one of the 8s")
...
bestCard = aiAttack.aiStartTurn(hand, trumpSuit, cardsRemaining, playerHands, lowestRank)
assert(bestCard ~= nil, "Should return a card from large hand")
-- Should prefer throwing lower cards
assert(bestCard.rank <= card.Rank.NINE, 
